                        ...
                        <div class="col-md-6">
                            <div class="card" style="width: 100%; border:2px solid black; border-radius:24px; margin-top:10px;">
                                <a class="post-img" href="single.php?post_id=<?php echo ($row['post_id']) ?>"><img
                                        style="height:150px; border-radius:44px;"
                                        src="admin/upload/<?php echo $row['post_img']; ?>" alt="Picture unlink" /></a>
                                <div class="card-body" style="margin:25px;">
                                    <h5 class="card-title"><a
                                            href='single.php?post_id=<?php echo ($row['post_id']) ?>'><?php echo substr($row['title'], 0, 25) . '....'; ?></a>
                                    </h5>
                                    <p class="card-text"><?php echo substr($row['description'], 0, 85) . '....'; ?></p>
                                    <a href='addtocart.php?post_id=<?php echo ($row['post_id']) ?>' class="btn btn-primary">Add
                                        to Cart</a>
