...
if (isset($_POST['submit'])) {
    ...
    $sql_update_post = "UPDATE post SET title = '{$post_title}', price = '{$price}', description = '{$post_decs}', category = '{$post_cate}', post_img = '{$save_img_name}' WHERE post_id = '{$post_id_by_addbar}';";
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                $sql_show_post_data = "SELECT post.post_id, post.category, post.title, post.price, post.description, post.post_date, post.post_img,
